            ...
            <div className="row">
                ...
                <div className="col-md-9 col-12 mb-2 m-0 p-0">
                    <div className="row border p-5">
                            <div>
                                <h1 className="text-center mt-4 ">Update Seller Profile</h1>
                            </div>
                            <hr className=" mt-3"/>
                            ...
                            <form className=" m-0 p-1">
                                ...
                                <div className="mb-3">
                                    <label htmlFor="Seller ID" className="form-label">Seller ID</label>
                                    <input type="text" className="form-control" id="Seller ID" />
                                </div>
                                <div className="mb-3">
